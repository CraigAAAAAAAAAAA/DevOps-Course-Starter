...
def test_done_items():
    items_done = [Item(2344,"Answer emails", "To do"), Item(2345,"Do exercise", "Started") , Item(2346,"Go Home", "Done")]
...
def test_in_progress():
    all_items = [Item(2344,"Answer emails", "To do"), Item(2345,"Do exercise", "Started") , Item(2346,"Go Home", "Done")]
